...
<body>
<div class="container">
	<label class="agendar">Asesores</label></div>
...
$query= "SELECT ar.idasesor AS idasesor, ar.idresidente AS idresidente, 
re.id AS id, re.nombre AS nombre, re.deptasig AS deptasig, re.correo AS correo FROM asres ar 
JOIN asesores re ON ar.idasesor=re.id WHERE idresidente = '".$_SESSION['idresidente']."'";
...
echo "<tr><th>Nombre</th><th>Departamento asignado</th><th>Correo</th></tr>";

while($Row=sqlsrv_fetch_array($stmt)){

    
    echo "<tr><td>" . $Row['nombre'] . "</td><td>" . $Row['deptasig']
     . "</td><td>" . $Row['correo'] . "</td></tr>";
}   
